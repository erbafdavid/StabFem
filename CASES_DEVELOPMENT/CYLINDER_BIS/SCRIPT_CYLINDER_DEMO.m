...
[wnl,meanflow,mode] = SF_WNL(bf,'Retest',47.5); % Here to generate a starting point for the next chapter
...
Fy_WNL = wnl.Fyeps*real(sqrt(epsilon2_WNL));
omega_WNL =Omegac + epsilon2_WNL* ( imag(wnl.Lambda) - real(wnl.Lambda)*imag(wnl.nu0+wnl.nu2)/real(wnl.nu0+wnl.nu2) ) ;
Fx_WNL = wnl.Fx0+wnl.Fxeps2*epsilon2_WNL+wnl.FxA20*A_WNL.^2;
