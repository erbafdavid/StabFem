...
Rbody = 0.5; Lel = 1; Lcyl = 2;Rpipe = 10; xmin = -10; xmax = 30;
Lbody=Lcyl+Lel;
bctype = 1;
...
% ReCS = 354.3757 -> -0.0026 - 0.0000i


% ReCI = 604.2750 -> -0.0008 + 0.5871i
 
  keepE2_Rp10LD3= [[1 2]' [10 10]' [3 3]' [354.3757 604.2750]' [0  0.5871]'];

 
 save('dataE2_Rp10LD3.txt','keepE2_Rp10LD3','-ascii');
