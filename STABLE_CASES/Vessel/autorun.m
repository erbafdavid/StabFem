...
subplot(1,3,1);
plotFF(emm1(2),'phi.im','title',{'Mode (m,n)= (1,0)',['freq = ',num2str(imag(evm1(2)))]},'symmetry','YA');hold on;plotFF_ETA(emm1(2),'symmetry','YA');
subplot(1,3,2);
plotFF(emm1(1),'phi.im','title',{'Mode (m,n)= (1,1)',['freq = ',num2str(imag(evm1(1)))]},'symmetry','YA');hold on;plotFF_ETA(emm1(1),'symmetry','YA');
subplot(1,3,3);
plotFF(emm1(3),'phi.im','title',{'Mode (m,n)= (1,2)',['freq = ',num2str(imag(evm1(3)))]},'symmetry','YA');hold on;plotFF_ETA(emm1(3),'symmetry','YA');
...
subplot(1,3,2);
plotFF(emm1(1),'phi.im','title',{'Mode (m,n)= (1,0)',['freq = ',num2str(imag(evm1(1)))]},'symmetry','YA');hold on;
