...
%
% usage in one-input mode : [baseflow,eigenmode] = SF_Init('Mesh.edp')
%
% usage in two-input mode : [baseflow,eigenmode] = SF_Init('Mesh.edp',params)
...
% a description file "mesh.mshinfo", and an initial base flow "BaseFlow_init.txt" / "BaseFlow_init.ff2m" 
%
