...
x0Source2 = linspace(0,2,nStream2);
y0Source2 = 2*ones(1,nStream2);

x0Source3 = linspace(2,4,nStream2);
y0Source3 = 3*ones(1,nStream2);

x0Source4 = linspace(-0.5,2,nStream2);
y0Source4 = 2.98*ones(1,nStream2);

x0Source5 = linspace(-0.5,0.5,nStream2);
y0Source5 = 2.9*ones(1,10);

x0Source6 = linspace(0.0,0.1,nStreamCoarse);
y0Source6 = 1.6*ones(1,5);

x0Source7 = linspace(2.185,2.21,nStream2);
y0Source7 = 0.43*ones(1,10);

% x0Source8 = 0.08*ones(1,20);
% y0Source8 = linspace(0.48,0.5,20);

x0Source8 = linspace(0.082,0.1,nStream2);
y0Source8 = 0.54*ones(1,10);

x0Source9 = linspace(0.082,0.086,nStream2);
y0Source9 = 0.51*ones(1,10);
...
if(iter==1)
    streamLinesVec = [streamlines, streamlines2, streamlines3,...
                      streamlines4, streamlines5, streamlines6, streamlines7];
else   
...
nameFigure = ['Figure',num2str(iter),'.svg'];
print('-painters',nameFigure,'-dsvg')
end
% 
% for iter=[1:4]
