...
Rbody = 0.5; Lel = 1; Lcyl = 5;Rpipe = 2.5; xmin = -10; xmax = 30;
Lbody=Lcyl+Lel;
bctype = 2;
...
keepE2_Rp25LD6= [[1 2]' [Rpipe Rpipe]' [Lbody Lbody]' [ReCS ReCI]' [0  ImCI]'];

save(['dataE2_Rp' num2str(Rpipe*100) 'LD' num2str(Lbody*100) '.txt'],['keepE2_Rp' num2str(Rpipe*100) 'LD' num2str(Lbody*100)],'-ascii');
