...
%  Usage : mesh=importFFdata(fileToRead1)
%  
...
disp(['FUNCTION  importFFmesh.m : reading file ' fileToRead1 ]);
...
if(exist([fileToRead1 'info'])==2)
    disp(['FUNCTION  importFFmesh.m : reading complementary file ' fileToRead1 'info' ]);
...
disp(['END FUNCTION importFFmesh.m'  ]);disp(' ');
end
