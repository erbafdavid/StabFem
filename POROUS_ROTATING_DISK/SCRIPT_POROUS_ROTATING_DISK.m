...
Omega = [0.];
    ...
    it=it;
    for Re = Re_start
        baseflow = SF_BaseFlow(baseflow,'Re',Re,'Porosity',0.,'Omegax',Omega);
        it = it+1;
        if (it==1) || (mod(it,1) == 0)% && (Re<150)
