...
Rbody = 0.5; Lel = 1; Lcyl = 5;Rpipe = 1.15; xmin = -10; xmax = 100;
...
%%% FIN PARAMETERS
    ...
    Re_start = [10,30,60,100,200,300,400,500,600,700,800,900]; 
...
ReI1i;
ReI1f=ReI1i-50;
    Re_RangeI1 = [ReI1i:-10:ReI1f];EVI1 = [];
        guessI1 = ev01;
...
ReI2i;
ReI2f=ReI2i-50;
    Re_RangeI2 = [ReI2i:-10:ReI2f];EVI2 = [];
        guessI2 = ev00;
