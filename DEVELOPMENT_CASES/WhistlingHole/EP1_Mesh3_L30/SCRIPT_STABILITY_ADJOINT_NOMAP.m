...
figure(120);hold off;
subplot(2,1,1);
plot(Re_Range,real(EVH2),'r-','',2);hold on;
...
Spectrum_2000_NoMap_L30 = [SpectrumA_0i;SpectrumA_1i;SpectrumA_2i;SpectrumA_3i;conj(SpectrumA_0i);SpectrumA_4i;conj(SpectrumA_1i);conj(SpectrumA_2i);conj(SpectrumA_3i);conj(SpectrumA_4i)];
save('Spectrum_2000_NoMap_L30','Spectrum_2000_NoMap_L30');

%%
figure(40);
plot(Spectrum_2000_NoMap_L30,'+')
...
Spectrum_1700_NoMap_L30 = [SpectrumA_0i;SpectrumA_1i;SpectrumA_2i;SpectrumA_3i;conj(SpectrumA_0i);SpectrumA_4i;conj(SpectrumA_1i);conj(SpectrumA_2i);conj(SpectrumA_3i);conj(SpectrumA_4i)];
save('Spectrum_1700_NoMap_L30','Spectrum_1700_NoMap_L30');

%%
figure(40);
plot(Spectrum_1700_NoMap_L30,'+')
