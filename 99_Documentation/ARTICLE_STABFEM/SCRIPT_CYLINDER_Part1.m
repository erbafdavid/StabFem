...
SF_Plot(bf,'p','contour','psi','clevels',[-.02 0 .2 1 2 5],'cstyle','patchdashedneg',...
      'xlim',[-1.5 4.5],'ylim',[0 3],'cbtitle','p','colormap','redblue','colorrange',...
      'centered','boundary','on','bdlabels',2,'bdcolors','k'); % figure 2
...
[ev,em] = SF_Stability(bf,'shift',-.03+.72i,'nev',1,'type','D');
    for Re = Re_Range
        bf = SF_BaseFlow(bf,'Re',Re);
        [ev,em] = SF_Stability(bf,'nev',1,'shift','cont','guess',em);
