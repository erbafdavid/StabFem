...
EVH1 = SF_Stability_LoopRe(bf,Re_RangeUP,-.04+.562i,'type','A','m',0);
...
plot(Re_Range,imag(EVH2),'r:',Re_Range,imag(EVH3),'b:',Re_Range,imag(EVH3),'g:');hold on;
...
save('results_nomap.mat',EV1_nomap,EV2_nomap,EV3_nomap,Re_range_nomap)
