...
% compute a spectrum  
 ...
 [ev4,eigenmode4] = SF_Stability(bf,'m',1,'shift',0.5,'nev',10,'plotspectrum','yes');   

 [ev5,eigenmode5] = SF_Stability(bf,'m',1,'shift',0.5+0.5i,'nev',10,'plotspectrum','yes');   

 [ev6,eigenmode6] = SF_Stability(bf,'m',1,'shift',0.5+2i,'nev',10,'plotspectrum','yes');   

 [ev7,eigenmode7] = SF_Stability(bf,'m',1,'shift',-0.25+2i,'nev',10,'plotspectrum','yes');   
pause(0.1);
