...
set(gca,'FontSize', 18);
saveas(gca,'Cylinder_Mesh2_Full',figureformat); 
...
set(gca,'FontSize', 18);
saveas(gca,'Cylinder_Mesh2',figureformat);
pause(0.1);
...
box on; pos = get(gcf,'Position'); pos(4)=pos(3)*.4;set(gcf,'Position',pos); % resize aspect ratio
set(gca,'FontSize', 18);
saveas(gca,'Cylinder_Mesh4_Full',figureformat); 
...
box on; pos = get(gcf,'Position'); pos(4)=pos(3)*AspectRatio;set(gcf,'Position',pos); % resize aspect ratio
set(gca,'FontSize', 18);
saveas(gca,'Cylinder_Mesh4',figureformat);
pause(0.1);
