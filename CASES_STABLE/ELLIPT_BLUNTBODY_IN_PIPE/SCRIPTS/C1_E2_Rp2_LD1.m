...
Rbody = 0.5; Lel = 1; Lcyl = 0.04;Rpipe = 2; xmin = -10; xmax = 60;
...
%%% FIN PARAMETERS
    ...
    Re_start = [10 , 30, 60, 100, 200,300,400,500,600]; 
...
% compute a spectrum  
 ...
 [ev2,eigenmode2] = SF_Stability(bf,'m',1,'shift',1.2i,'nev',10,'plotspectrum','yes');   

 [ev3,eigenmode3] = SF_Stability(bf,'m',1,'shift',0.7i,'nev',10,'plotspectrum','yes');   
